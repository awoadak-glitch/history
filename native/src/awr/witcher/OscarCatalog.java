...
final class OscarCatalog {
    ...
    static String sectionKind(String type){if(type.startsWith("anime_"))return type.contains("episode")?"anime_episode":"anime";if(type.contains("wrestling"))return "wrestling";if(type.startsWith("movies"))return "movie";if(type.equals("latest_episodes"))return "episode";if(type.contains("channels"))return type.contains("country")||type.contains("category")?"":"channel";if(type.contains("matches"))return "match";if(type.contains("series")||type.equals("featured")||type.equals("latest")||type.equals("top_rated")||type.equals("most_viewed"))return "series";return "";}
