...
final class OscarApi {
    ...
    static String httpError(int code){if(code==401||code==403)return "رفض خادم Oscar الوصول (HTTP "+code+"). يلزم أن يسمح المصدر بالاتصال؛ تغيير المشغل لا يحل هذا الرفض.";return "تعذر تحميل المحتوى من المصدر (HTTP "+code+").";}
